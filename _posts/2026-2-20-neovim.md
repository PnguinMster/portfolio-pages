...
{% include image_md.html src="/images/Blogs/single_neovim_editor/code_editor_logos.jpg" alt="Code Editors image" fig="Image of different code editors" %}
...
{% include image_md.html src="/images/Blogs/single_neovim_editor/vscode_logo_img.jpg" alt="VSCode Logo image" fig="VSCode Logo" %}
{% include image_md.html src="/images/Blogs/single_neovim_editor/atom_logo_img.jpg" alt="Atom Logo image" fig="Atom Logo" %}
...
{% include image_md.html src="/images/Blogs/single_neovim_editor/vscode_simple_layout.jpg" alt="Clean VSCode layout image" fig="Layout of my VSCode after being customized" %}
...
{% include image_md.html src="/images/Blogs/single_neovim_editor/bare_bones_neovim_start.jpg" alt="Bare Bone Neovim Image" fig="Bare bones NeoVim" %}
{% include image_md.html src="/images/Blogs/single_neovim_editor/bare_bones_neovim_file.jpg" alt="Bare Bone Neovim file Image" fig="Bare bones file in NeoVim" %}
...
{% include image_md.html src="/images/Blogs/single_neovim_editor/lazyvim_window_base.jpg" alt="Lazy Neovim image" fig="Image of Lazy Neovim and its starting configuration" %}
{% include image_md.html src="/images/Blogs/single_neovim_editor/lazyvim_window_file.jpg" alt="Lazy Neovim file image" fig="Image of Lazy Neovim and its starting file" %}
...
{% include image_md.html src="/images/Blogs/single_neovim_editor/kickstart_window_base.jpg" alt="kickstart Neovim image" fig="Image of Kickstart Neovim and its starting configuration" %}
{% include image_md.html src="/images/Blogs/single_neovim_editor/kickstart_window_file.jpg" alt="kickstart Neovim file image" fig="Image of Kickstart Neovim and its starting file" %}
...
{% include image_md.html src="/images/Blogs/single_neovim_editor/kickstart_window_base.jpg" alt="kickstart Neovim image" fig="Image of Kickstart Neovim and its starting configuration" %}
{% include image_md.html src="/images/Blogs/single_neovim_editor/kickstart_window_file.jpg" alt="kickstart Neovim file image" fig="Image of Kickstart Neovim and its starting configuration file" %}
...
{% include image_md.html src="/images/Blogs/single_neovim_editor/current_telescope_window.jpg" alt=Telescope Image" fig="Telescope floating window" %}
...
{% include image_md.html src="/images/Blogs/single_neovim_editor/terminal-windows_clean.jpg" alt=LazyGit Image" fig="LazyGit terminal window" %}
...
{% include image_md.html src="/images/Blogs/single_neovim_editor/current_lazygit_window.jpg" alt=LazyGit Image" fig="LazyGit terminal window" %}
...
{% include image_md.html src="/images/Blogs/single_neovim_editor/current_undotree.jpg" alt=UndoTree Image" fig="Undotree layout window" %}
...
{% include image_md.html src="/images/Blogs/single_neovim_editor/current_starter_window.jpg" alt="NeoVim Image" fig="Current NeoVim layout I use" %}
{% include image_md.html src="/images/Blogs/single_neovim_editor/current_file_theme.jpg" alt="NeoVim file Image" fig="Current NeoVim layout file I use" %}
